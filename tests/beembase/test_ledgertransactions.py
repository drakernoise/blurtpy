...
from blurtgraphenebase import account
from blurtbase.operationids import getOperationNameForId
from blurtgraphenebase.py23 import py23_bytes, bytes_types
...
class Testcases(unittest.TestCase):
    ...
    def test_vote(self):
        ...
        **{
        "voter": "nettybot",
        "author": "jrcornel",
        "permlink": "blurt-sitting-back-at-previous-support-levels-is-this-a-buy",
        "weight": 10000
        }
        )
