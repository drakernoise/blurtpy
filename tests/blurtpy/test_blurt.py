...
class Testcases(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.bts = Blurt(
            ...
            num_retries=10)
        cls.account = Account("test", full=True, blurt_instance=cls.bts)
    ...
    def test_transfer(self):
        ...
        amount = Amount(op["amount"], blurt_instance=bts)
        self.assertEqual(float(amount), 1.33)

    def test_create_account(self):
        bts = Blurt(node=get_blurt_nodes(),
                    nobroadcast=True,
                    unsigned=True,
                    data_refresh_time_seconds=900,
                    keys={"active": wif, "owner": wif2, "memo": wif3},
    ...
    def test_post(self):
        ...
        self.assertEqual(json_metadata["app"], "blurtpy/%s" % (blurtpy_version))
    ...
    def test_comment_option(self):
        ...
        self.assertEqual(10000, op["percent_blurt_dollars"])
    ...
    def test_offline(self):
        ...
        self.assertFalse(bts.is_blurt)
        self.assertTrue(bts.is_blurt)        
    ...
    def test_properties(self):
        ...
        self.assertTrue(bts.get_blockchain_name() == "blurt")
        self.assertFalse(bts.is_blurt)
        self.assertTrue(bts.is_blurt)        
    ...
    def test_sbd_to_rshares(self):
        ...
        for v in test_values:
            ...
            except ValueError:  # Reward pool smaller than 1e7 SBD (e.g. caused by a very low blurt price)
                continue
    ...
    def test_rshares_to_vote_pct(self):
        ...
        for vote_pct in range(500, 10000, 500):
            ...
            vote_pct_ret = stm.rshares_to_vote_pct(rshares, blurt_power=sp, voting_power=voting_power)
    ...
    def test_switch_blockchain(self):
        bts = Blurt(
            node=get_blurt_nodes(),
            num_retries=10)        
        bts.switch_blockchain("blurt", update_nodes=True)
        assert not bts.is_blurt
        bts.switch_blockchain("blurt", update_nodes=True)
        assert bts.is_blurt        
