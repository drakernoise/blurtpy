...
from blurtpy.discussions import (
...
class Testcases(unittest.TestCase):
    ...
    def test_trending(self):
        ...
        d = Discussions_by_trending(query, blurt_instance=bts)
    ...
    #    query["limit"] = 10
    #    # query["tag"] = "fullnodeupdate"
    #    d = Comment_discussions_by_payout(query, blurt_instance=bts)
    #    self.assertEqual(len(d), 10)
    ...
    #    query["limit"] = 10
    #    # query["tag"] = "fullnodeupdate"
    #    d = Post_discussions_by_payout(query, blurt_instance=bts)
    #    self.assertEqual(len(d), 10)
    ...
    def test_created(self):
        ...
        query["limit"] = 2
        query["tag"] = "blurt"
        d = Discussions_by_created(query, blurt_instance=bts)
    ...
    #    query["limit"] = 10
    #    query["tag"] = "fullnodeupdate"
    #    d = Discussions_by_active(query, blurt_instance=bts)
    #    self.assertEqual(len(d), 10)

    #def test_cashout(self):
    #    bts = self.bts
    #    query = Query(limit=10)
    #    Discussions_by_cashout(query, blurt_instance=bts)
    #    # self.assertEqual(len(d), 10)
    ...
    #    query["limit"] = 10
    #    query["tag"] = "fullnodeupdate"
    #    d = Discussions_by_votes(query, blurt_instance=bts)
    #    self.assertEqual(len(d), 10)
    ...
    #    query["limit"] = 10
    #    query["tag"] = "holger80"
    #    d = Discussions_by_children(query, blurt_instance=bts)
    #    self.assertEqual(len(d), 10)
    ...
    def test_feed(self):
        ...
        query["limit"] = 10
        query["tag"] = "holger80"
        d = Discussions_by_feed(query, blurt_instance=bts)
        self.assertEqual(len(d), 10)
    ...
    def test_blog(self):
        ...
        query["limit"] = 10
        query["tag"] = "fullnodeupdate"
        d = Discussions_by_blog(query, blurt_instance=bts)
        self.assertEqual(len(d), 10)
    ...
    def test_comments(self):
        ...
        d = Discussions_by_comments(query, blurt_instance=bts)
    ...
    def test_promoted(self):
        ...
        query["limit"] = 2
        query["tag"] = "blurt"
        d = Discussions_by_promoted(query, blurt_instance=bts)
        discussions = Discussions(blurt_instance=bts)
        d2 = []
