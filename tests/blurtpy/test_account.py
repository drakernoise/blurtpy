...
class Testcases(unittest.TestCase):
    ...
    def test_estimate_virtual_op_num(self):
        stm = self.bts
        account = Account("artemisa7", blurt_instance=stm)
        block_num = 21248120
    ...
    def test_blog_history(self):
        account = Account("artemisa7", blurt_instance=self.bts)
        posts = []
    ...
    def test_extract_account_name(self):
        stm = self.bts
        account = Account("artemisa7", blurt_instance=stm)
        self.assertEqual(extract_account_name(account), "artemisa7")
        self.assertEqual(extract_account_name("artemisa7"), "artemisa7")
        self.assertEqual(extract_account_name({"name": "artemisa7"}), "artemisa7")
