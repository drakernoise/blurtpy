...
from blurtpy.exceptions import BlockWaitTimeExceeded
...
class Testcases(unittest.TestCase):
    ...
    def test_hash_op(self):
        bts = self.bts
        b = Blockchain(blockchain_instance=bts)
        op1 = {'type': 'vote_operation', 'value': {'voter': 'ubg', 'author': 'yesslife', 'permlink': 'blurtit-sandwich-contest-week-25-2da-entry', 'weight': 100}}
        op2 = ['vote', {'voter': 'ubg', 'author': 'yesslife', 'permlink': 'blurtit-sandwich-contest-week-25-2da-entry', 'weight': 100}]
        hash1 = b.hash_op(op1)
        hash2 = b.hash_op(op2)
