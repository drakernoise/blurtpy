...
from blurtgraphenebase.version import version as blurtpy_version
...
class GrapheneRPC(object):
    ...
    Usage:
        ...
        .. code-block:: python
            ...
            ws = GrapheneRPC("wss://blurtd.pevo.science","","")
            print(ws.get_account_count())

            ws = GrapheneRPC("https://api.blurtit.com","","")
            print(ws.get_account_count())
        ...
        while True:
            if next_url:
                ...
                if self.url[:3] == "wss":
                    ...
                    self.headers = {'User-Agent': 'blurtpy v%s' % (blurtpy_version),
    ...
    def get_network(self, props=None):
        ...
        for k, v in list(self.known_chains.items()):
            if blockchain_name is not None and blockchain_name not in k and blockchain_name != "BLURTIT" and blockchain_name != "CHAIN":
                continue 
