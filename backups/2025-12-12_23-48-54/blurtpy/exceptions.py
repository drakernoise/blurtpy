...
class WalletExists(Exception):
    """ A wallet has already been created and requires a password to be
        unlocked by means of :func:`blurtpy.wallet.Wallet.unlock`.
    """
    pass
...
class VotingInvalidOnArcblurtdPost(Exception):
    """ The transaction requires signature of a higher authority
    """
    pass
...
class NoWalletException(Exception):
    """ No Wallet could be found, please use :func:`blurtpy.wallet.Wallet.create` to
        create a new wallet
    """
    pass
