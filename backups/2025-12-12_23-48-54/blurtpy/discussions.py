...
class Query(dict):
    """ Query to be used for all discussion queries
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query
            query = Query(limit=10, tag="blurtit")
    ...
    def get_discussions(self, discussion_type, discussion_query, limit=1000, raw_data=False):
        """ Get Discussions
            ...
            .. testcode::
                ...
                from blurtpy.discussions import Query, Discussions
                query = Query(limit=51, tag="blurtit")
...
class Discussions_by_trending(list):
    """ Get Discussions by trending
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_trending
            q = Query(limit=10, tag="blurt")
...
class Discussions_by_author_before_date(list):
    """ Get Discussions by author before date
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_author_before_date
...
class Comment_discussions_by_payout(list):
    """ Get comment_discussions_by_payout
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Comment_discussions_by_payout
            q = Query(limit=10)
...
class Post_discussions_by_payout(list):
    """ Get post_discussions_by_payout
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Post_discussions_by_payout
            q = Query(limit=10)
...
class Discussions_by_active(list):
    """ get_discussions_by_active
        ...
        :param bool use_appbase: use condenser call when set to False, default is False
        :param bool raw_data: returns list of comments when False, default is False
        :param Blurt blockchain_instance: Blurt() instance to use when accesing a RPC

        .. testcode::

            from blurtpy.discussions import Query, Discussions_by_active
            q = Query(limit=10)
...
class Discussions_by_cashout(list):
    """ Get discussions_by_cashout. This query seems to be broken at the moment.
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_cashout
            q = Query(limit=10)
...
class Discussions_by_votes(list):
    """ Get discussions_by_votes
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_votes
            q = Query(limit=10)
...
class Discussions_by_children(list):
    """ Get discussions by children
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_children
            q = Query(limit=10)
...
class Discussions_by_hot(list):
    """ Get discussions by hot
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_hot
            q = Query(limit=10, tag="blurt")
...
class Discussions_by_feed(list):
    """ Get discussions by feed
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_feed
            q = Query(limit=10, tag="blurt")
...
class Discussions_by_blog(list):
    """ Get discussions by blog
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_blog
            q = Query(limit=10)
...
class Discussions_by_comments(list):
    """ Get discussions by comments
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_comments
            q = Query(limit=10, start_author="blurtit", start_permlink="firstpost")
...
class Discussions_by_promoted(list):
    """ Get discussions by promoted
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Discussions_by_promoted
            q = Query(limit=10, tag="blurt")
...
class Replies_by_last_update(list):
    """ Returns a list of replies by last update
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Replies_by_last_update
            q = Query(limit=10, start_parent_author="blurtit", start_permlink="firstpost")
...
class Trending_tags(list):
    """ Returns the list of trending tags.
        ...
        .. testcode::
            ...
            from blurtpy.discussions import Query, Trending_tags
