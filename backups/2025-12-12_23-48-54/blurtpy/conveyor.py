...
from blurtgraphenebase.py23 import py23_bytes
from blurtgraphenebase.ecdsasig import sign_message
try:
...
class Conveyor(object):
    """ Class to access Blurtit Conveyor instances:
        https://github.com/blurtit/conveyor
        ...
        * Draft handling: saving, listing and removing post drafts
        ...
        described here: https://github.com/blurtit/rpc-auth

    """

    def __init__(self, url="https://conveyor.blurtit.com",
                 blockchain_instance=None, **kwargs):
        """ Initialize a Conveyor instance
            :param str url: (optional) URL to the Conveyor API, defaults to
                https://conveyor.blurtit.com
            :param blurtpy.blurt.Blurt blockchain_instance: Blurt instance
        ...
        self.K = hashlib.sha256(py23_bytes('blurt_jsonrpc_auth',
    ...
    def _request(self, account, method, params, key):
        """Assemble the request, hash it, sign it and send it to the Conveyor
            ...
            :param str key: Blurt posting key for signing
    ...
    def _conveyor_method(self, account, signing_account, method, params):
        ...
        if signing_account is None:
            ...
            signer = Account(signing_account, blockchain_instance=self.blurt)
        ...
        for authority in signer["posting"]["key_auths"]:
            posting_wif = self.blurt.wallet.getPrivateKeyForPublicKey(
                authority[0])
    ...
    def set_user_data(self, account, params, signing_account=None):
        """ Set the account's email address and phone number. The request has to be
            ...
            .. code-block:: python
                ...
                from blurtpy import Blurt
                from blurtpy.conveyor import Conveyor
                s = Blurt(keys=["5JADMINPOSTINGKEY"])
                c = Conveyor(blockchain_instance=s)
