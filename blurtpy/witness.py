...
from blurtbase import transactions, operations
...
class Witness(BlockchainObject):
    """ Read data about a witness in the chain
        ...
        :param Blurt blurt_instance: Blurt instance to use when
               accesing a RPC
...
class WitnessesObject(list):
    def printAsTable(self, sort_key="votes", reverse=True, return_str=False, **kwargs):
        ...
        if sort_key == 'base':
            ...
            sortedList = sorted(self, key=lambda self: (utc.localize(datetime.now(timezone.utc)) - self[last_bd_exchange_update]).total_seconds(), reverse=reverse)
...
class GetWitnesses(WitnessesObject):
    """ Obtain a list of witnesses
        ...
        :param Blurt blurt_instance: Blurt() instance to use when
            accessing a RPCcreator = Witness(creator, blurt_instance=self)

        .. code-block:: python

            from blurtpy.witness import GetWitnesses
...
class Witnesses(WitnessesObject):
    """ Obtain a list of **active** witnesses and the current schedule
        ...
        .. code-block:: python
           ...
           >>> from blurtpy.witness import Witnesses
           >>> Witnesses()
           <Witnesses >
...
class WitnessesVotedByAccount(WitnessesObject):
    """ Obtain a list of witnesses which have been voted by an account
        ...
        .. code-block:: python
           ...
           >>> from blurtpy.witness import WitnessesVotedByAccount
...
class WitnessesRankedByVote(WitnessesObject):
    """ Obtain a list of witnesses ranked by Vote
        ...
        .. code-block:: python
           ...
           >>> from blurtpy.witness import WitnessesRankedByVote
...
class ListWitnesses(WitnessesObject):
    """ List witnesses ranked by name
        ...
        .. code-block:: python
           ...
           >>> from blurtpy.witness import ListWitnesses
