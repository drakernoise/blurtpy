...
from blurtgraphenebase.py23 import integer_types, string_types, text_type
...
from blurtapi.exceptions import UnkownKey
...
class Vote(BlockchainObject):
    """ Read data about a Vote in the chain
        ...
        :param Blurt blurt_instance: Blurt() instance to use when accesing a RPC
        ...
        .. code-block:: python
           ...
           >>> stm = Blurt()
           >>> v = Vote("@gtg/blurt-pressure-4-need-for-speed|gandalf", blurt_instance=stm)
