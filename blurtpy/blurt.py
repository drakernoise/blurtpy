...
class Blurt(BlockChainInstance):
    ...
    def get_blurt_per_mvest(self, time_stamp=None, use_stored_data=True):
        ...
        if "total_vesting_fund_blurt" in global_properties:
            return (
    ...
    def sp_to_sbd(self, sp, post_rshares=0, voting_power=BLURT_100_PERCENT, vote_pct=BLURT_100_PERCENT, not_broadcasted_vote=True, use_stored_data=True):
        """ Obtain the resulting SBD vote value from Blurt power
    ...
    def sp_to_rshares(self, blurt_power, post_rshares=0, voting_power=BLURT_100_PERCENT, vote_pct=BLURT_100_PERCENT, use_stored_data=True):
    ...
    def vests_to_rshares(self, vests, post_rshares=0, voting_power=BLURT_100_PERCENT, vote_pct=BLURT_100_PERCENT, subtract_dust_threshold=True, use_stored_data=True):
    ...
    def rshares_to_vote_pct(self, rshares, post_rshares=0, blurt_power=None, vests=None, voting_power=BLURT_100_PERCENT, use_stored_data=True):
        ...
        used_power = int(math.ceil(abs(rshares) * BLURT_100_PERCENT / vests))
