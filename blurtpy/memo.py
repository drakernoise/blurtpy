...
from blurtgraphenebase.base58 import base58encode, base58decode
from blurtpy.version import version as __version__
from blurtbase import memo as BtsMemo
...
class Memo(object):
    """ Deals with Memos that are attached to a transfer
        ...
        In Blurt, memos are AES-256 encrypted with a shared secret between sender and
        ...
        The high level memo class makes use of the blurtpy wallet to obtain keys
    ...
    def decrypt_binary(self, infile, outfile, buffer_size=2048):
        ...
        blurtpy_version = BtsMemo.decode_memo(
                priv,
                memo
            )
        ...
        return {
            ...
            "to_key": str(to_key),
            "nonce": nonce,
            "blurtpy_version": blurtpy_version
        }
