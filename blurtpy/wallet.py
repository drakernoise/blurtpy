...
class Wallet(object):
    """ The wallet is meant to maintain access to private keys for
        ...
        :param BlurtNodeRPC rpc: RPC connection to a Blurt node
        ...
        * **Wallet Database**: Here, blurtpy loads the keys from the
          locally stored wallet SQLite database (see ``storage.py``).
          To use this mode, simply call :class:`blurtpy.blurt.Blurt` without the
          ``keys`` parameter
        * **Providing Keys**: Here, you can provide the keys for
          your accounts manually. All you need to do is add the wif
          keys for the accounts you want to use as a simple array
          using the ``keys`` parameter to :class:`blurtpy.blurt.Blurt`.
        * **Force keys**: This more is for advanced users and
        ...
        .. code-block:: python
           ...
           blurt = Blurt()
           blurt.wallet.wipe(True)
           blurt.wallet.create("supersecret-passphrase")

        This will raise :class:`blurtpy.exceptions.WalletExists` if you already have a wallet installed.
        ...
        **after** unlocking the wallet with the correct passphrase:
        ...
        .. code-block:: python
           ...
           blurt = Blurt()
           blurt.wallet.unlock("supersecret-passphrase")
           blurt.wallet.addPrivateKey("5xxxxxxxxxxxxxxxxxxxx")
    ...
    def getKeyType(self, account, pub):
        """ Get key type
            ...
            :param blurtpy.account.Account/dict account: Account data
