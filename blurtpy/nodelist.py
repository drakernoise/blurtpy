...
class NodeList(list):
    """ Returns BLURT/BLURT nodes as list
    ...
    def __init__(self):
        nodes = [
            ...
            {
                "url": "https://blurtdev.techcoderx.com",
                "version": "0.20.2",
                "type": "appbase",
                "owner": "blurtit",
                "blurt": True,
            ...
            # },
            # {
                # "url": "https://api.blurtdb.online",
                # "version": "0.23.0",
                # "type": "appbase",
                # "owner": "blurt_supporter",
                # "blurt": False,
                # "score": 20
            # },
            # {
                # "url": "https://api.blurt.buzz",
                # "version": "0.23.0",
                # "type": "appbase",
                # "owner": "ericet",
                # "blurt": False,
            ...
            # },
            # {
                # "url": "https://blurt-test-beeabode.roelandp.nl",
                # "version": "0.23.0",
                # "type": "testnet",
                # "owner": "roelandp",
                # "blurt": True,
            ...
            # },
            # {
                # "url": "https://api.openblurt.network",
                # "version": "0.23.0",
                # "type": "appbase",
                # "owner": "gtg",
                # "blurt": True,
            ...
            # },
            # {
                # "url": "https://blurt-api.arcange.eu",
                # "version": "1.24.2",
                # "type": "appbase",
                # "owner": "arcange",
                # "blurt": True,
    ...
    def update_nodes(self, weights=None, blockchain_instance=None, **kwargs):
        ...
        while metadata is None and cnt < 5:
            cnt += 1
            try:
                account = Account("fullnodeupdate", blockchain_instance=blurt)
